...
namespace Cohee.IO
{
	...
	public static class DirectoryOp
    {
        ...
        public static bool Exists(string path)
        {
            ...
            return CoheeApp.SystemBackend.FileSystem.DirectoryExists(path);
        }
        /// <summary>
        ...
        public static void Create(string path)
        {
            ...
            PathOp.CheckInvalidPathChars(path);
            CoheeApp.SystemBackend.FileSystem.CreateDirectory(path);
        }
        /// <summary>
        ...
        public static void Delete(string path)
        {
            ...
            PathOp.CheckInvalidPathChars(path);
            CoheeApp.SystemBackend.FileSystem.DeleteDirectory(path);
        }
        /// <summary>
        ...
        public static IEnumerable<string> GetFiles(string path, bool recursive = false)
        {
            ...
            PathOp.CheckInvalidPathChars(path);
            return CoheeApp.SystemBackend.FileSystem.GetFiles(path, recursive);
        }
        /// <summary>
        ...
        public static IEnumerable<string> GetDirectories(string path, bool recursive = false)
        {
            if (string.IsNullOrWhiteSpace(path)) return Enumerable.Empty<string>();
            PathOp.CheckInvalidPathChars(path);
            return CoheeApp.SystemBackend.FileSystem.GetDirectories(path, recursive);
        }
    }
}
