...
{
    /// <summary>
	/// Manages loading, reloading, initialization and disposal of Cohee core plugins.
	/// 
	...
	/// then cause problems.
	/// 
	/// A static instance of this class is available through <see cref="CoheeApp.PluginManager"/>.
	/// </summary>
	public class CorePluginManager : PluginManager<CorePlugin>
    {
        private Assembly[] coreAssemblies = new Assembly[] { typeof(CoheeApp).GetTypeInfo().Assembly };
        ...
        /// its forced singleton-like usage. Use <see cref="CoheeApp.PluginManager"/> instead.
        /// </summary>
        ...
        /// <summary>
        /// Enumerates all currently loaded assemblies that are part of Cohee, i.e. Cohee itself and all loaded plugins.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Loads all available core plugins, as well as auxiliary libraries.
        /// </summary>
