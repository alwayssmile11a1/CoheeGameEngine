...
{
    /// <summary>
	/// DrawTechniques represent the method by which a set of colors, <see cref="Cohee.Resources.Texture">Textures</see> and
	/// vertex data is applied to screen. 
	/// </summary>
	/// <seealso cref="Cohee.Resources.Material"/>
	/// <seealso cref="Cohee.Resources.FragmentShader"/>
	/// <seealso cref="Cohee.Resources.VertexShader"/>
	/// <seealso cref="Cohee.Drawing.BlendMode"/>
    ...
    public class DrawTechnique : Resource
    {
        ...
        public void Compile()
        {
            ...
            if (this.nativeShader == null)
                this.nativeShader = CoheeApp.GraphicsBackend.CreateShaderProgram();
