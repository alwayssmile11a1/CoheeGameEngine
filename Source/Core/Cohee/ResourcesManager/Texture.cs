...
namespace Cohee.Resources
{
    ...
    /// </summary>
    /// <seealso cref="Cohee.Resources.Pixmap"/>
    /// <seealso cref="Cohee.Resources.RenderTarget"/>
    ...
    {
        /// <summary>
        /// [GET] A Texture showing the Cohee icon.
        /// </summary>
        public static ContentRef<Texture> CoheeIcon { get; private set; }
        /// <summary>
        /// [GET] A Texture showing the Cohee icon without the text on it.
        /// </summary>
        public static ContentRef<Texture> CoheeIconB { get; private set; }
        /// <summary>
        /// A Texture showing the Cohee logo.
        /// </summary>
        public static ContentRef<Texture> CoheeLogoBig { get; private set; }
        /// <summary>
        /// A Texture showing the Cohee logo.
        /// </summary>
        public static ContentRef<Texture> CoheeLogoMedium { get; private set; }
        /// <summary>
        /// A Texture showing the Cohee logo.
        /// </summary>
        public static ContentRef<Texture> CoheeLogoSmall { get; private set; }
        /// <summary>
        ...
        /// <summary>
        /// Reloads this Textures pixel data. If the referred <see cref="Cohee.Resources.Pixmap"/> has been modified,
        ...
        /// <summary>
        /// Loads the specified <see cref="Cohee.Resources.Pixmap">Pixmaps</see> pixel data.
        /// </summary>
        /// <param name="basePixmap">The <see cref="Cohee.Resources.Pixmap"/> that is used as pixel data source.</param>
        ...
        {
            if (this.nativeTex == null) this.nativeTex = CoheeApp.GraphicsBackend.CreateTexture();
        ...
        /// <summary>
        /// Does a safe (null-checked, clamped) texture <see cref="Cohee.Resources.Pixmap.Atlas"/> lookup.
        /// </summary>
