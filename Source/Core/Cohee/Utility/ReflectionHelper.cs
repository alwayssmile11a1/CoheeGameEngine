    ...
    public static class ReflectionHelper
    {
		...
		public static MemberInfo ResolveMember(string memberString)
        {
            lock (memberResolveCache)
            {
                ...
                Assembly[] searchAsm = CoheeApp.AssemblyLoader.LoadedAssemblies.Except(CoheeApp.CorePluginManager.DisposedPlugins).ToArray();
        ...
        private static Type ResolveType(string typeString, IEnumerable<Assembly> searchAsm, MethodInfo declaringMethod)
        {
            ...
            lock (typeResolveCache)
            {
                ...
                if (searchAsm == null)
                {
                    searchAsm = CoheeApp.AssemblyLoader.LoadedAssemblies.Except(CoheeApp.CorePluginManager.DisposedPlugins).ToArray();
                }
