...
{
    /// <summary>
	/// GameObjects are what every <see cref="Cohee.Resources.Scene"/> consists of. They represent nodes in the hierarchial scene graph and
	/// can maintain a <see cref="Cohee.Resources.PrefabLink"/> connection. A GameObject's main duty is to group several <see cref="Component"/>s
	/// to form one logical instance of an actual object as part of the game, such as "Car" or "PlayerCharacter". However,
	/// the GameObjects itself does not contain any game-related logic and, by default, doesn't even occupy a position in space.
	/// This is the job of its Components.
	/// </summary>
	/// <seealso cref="Component"/>
	/// <seealso cref="Cohee.Resources.Scene"/>
	/// <seealso cref="Cohee.Resources.PrefabLink"/>
    ...
    public sealed class GameObject : IManageableObject, IUniqueIdentifyable, ICloneExplicit
    {
        ...
        /// <summary>
        /// [GET] The GameObjects parent <see cref="Cohee.Resources.Scene"/>. Each GameObject can belong to
        /// exactly one Scene, or no Scene at all. To add or remove GameObjects to / from a Scene, use the <see cref="Cohee.Resources.Scene.AddObject(Cohee.GameObject)"/> and
        /// <see cref="Cohee.Resources.Scene.RemoveObject(Cohee.GameObject)"/> methods.
        /// </summary>
        public Scene Scene
        {
        ...
        /// <summary>
        /// [GET] The <see cref="Cohee.Resources.PrefabLink"/> that connects this object to a <see cref="Cohee.Resources.Prefab"/>.
        /// </summary>
        /// <seealso cref="Cohee.Resources.PrefabLink"/>
        /// <seealso cref="Cohee.Resources.Prefab"/>
        ...
        /// <summary>
        /// [GET] The <see cref="Cohee.Resources.PrefabLink"/> that connects this object or one or its parent GameObjects to a <see cref="Cohee.Resources.Prefab"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// [GET] The GameObject's <see cref="Cohee.Components.Transform"/> Component, if existing.
        /// This is a cached / faster shortcut-version of <see cref="GetComponent{T}"/>.
        /// </summary>
        /// <seealso cref="Cohee.Components.Transform"/>
        ...
        /// <summary>
        /// Creates a GameObject based on a specific <see cref="Cohee.Resources.Prefab"/>.
        /// </summary>
        ...
        public GameObject(ContentRef<Prefab> prefab)
        {
            ...
            if (CoheeApp.ExecContext == CoheeApp.ExecutionContext.Game)
            {
        ...
        /// <summary>
        /// Sets or alters this GameObject's <see cref="Cohee.Resources.PrefabLink"/> to reference the specified <see cref="Prefab"/>.
        /// </summary>
        ...
        /// <summary>
        /// Breaks this GameObject's <see cref="Cohee.Resources.PrefabLink"/>
        /// </summary>
