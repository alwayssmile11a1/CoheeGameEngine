...
namespace Cohee.Serialization
{
    ...
    /// <summary>
    /// Extension methods for <see cref="Cohee.Serialization.DataType"/>
    /// </summary>
    public static class ExtMethodsDataType
    {
        /// <summary>
        /// Returns whether the <see cref="Cohee.Serialization.DataType"/> represents a primitive data type.
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns whether the <see cref="Cohee.Serialization.DataType"/> represents a <see cref="System.Reflection.MemberInfo"/> type.
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns the actual <see cref="System.Type"/> that is associated with the <see cref="Cohee.Serialization.DataType"/>.
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
