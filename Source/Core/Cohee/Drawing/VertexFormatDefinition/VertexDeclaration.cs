...
namespace Cohee.Drawing
{
    ...
    public class VertexDeclaration
    {
        ...
        private static List<VertexDeclaration> declarationByIndex = new List<VertexDeclaration>();
        ...
        {
            if (typeIndex < 0 || typeIndex >= declarationByIndex.Count)
                return null;
            else
                return declarationByIndex[typeIndex];
        }
        /// <summary>
        /// Retrieves the <see cref="VertexDeclaration"/> for the vertex type specified
        ...
        private VertexDeclaration(Type dataType, int typeIndex)
        {
            ...
            while (declarationByIndex.Count <= this.typeIndex)
                declarationByIndex.Add(null);
            declarationByIndex[this.typeIndex] = this;
        }
