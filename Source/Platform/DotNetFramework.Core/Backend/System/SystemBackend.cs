...
namespace Cohee.Backend.DotNetFramework
{
    ...
    public class SystemBackend : ISystemBackend
    {
        ...
        string ICoheeBackend.Id
        {
            get { return "DotNetFrameworkSystemBackend"; }
        }
        string ICoheeBackend.Name
        {
            get { return ".Net Framework"; }
        }
        int ICoheeBackend.Priority
        {
            get { return 0; }
        }
        ...
        bool ICoheeBackend.CheckAvailable()
        {
            return true;
        }
        void ICoheeBackend.Init() { }
        void ICoheeBackend.Shutdown() { }
